...
func main() {
	...
	const (
		...
		seleniumPath    = "/home/jcde/go/pkg/mod/github.com/tebeka/vendor/selenium-server-standalone-3.4.jar"
		geckoDriverPath = "/home/jcde/go/pkg/mod/github.com/tebeka/vendor/geckodriver-v0.18.0-linux64"
		port            = 8080
	)
